...
export const PS_THEMES: PsTheme[] = [
  // ── 1. Dark Academia — DEFAULT ──────────────────────────────────────
  {
    ...
    dark: tk({
      ...
      surface: "0 0% 6%", surfaceLight: "0 0% 10%",
      sidebarBg: "0 0% 2%", sidebarFg: "0 0% 93%",
      sidebarPrimary: "350 50% 54%", sidebarPrimaryFg: "0 0% 3%",
      sidebarAccent: "0 0% 8%", sidebarAccentFg: "0 0% 96%",
      sidebarBorder: "0 0% 94% / 0.06", sidebarRing: "350 50% 54%",
      shadowSoft: SHADOW_DARK_SOFT, shadowElev: SHADOW_DARK_ELEV,
      fontDisplay: F_FRAUNCES_GEIST.display, fontBody: F_FRAUNCES_GEIST.body, fontMono: F_FRAUNCES_GEIST.mono,
      radius: "0.25rem", radiusSm: "0.125rem", spaceUnit: "5px", ease: EASE_ACADEMIA,
      bgGradient: "radial-gradient(ellipse 80% 30% at 50% 0%, hsl(350 50% 54% / 0.07) 0%, transparent 55%), hsl(0 0% 3%)",
    }),
  },
  ...
  // ── 3. Nordic Frost ─────────────────────────────────────────────────
  {
    ...
    dark: tk({
      bg: "252 22% 5%", fg: "250 18% 94%",
      card: "252 20% 9%", cardFg: "250 18% 94%",
      popover: "252 20% 10%", popoverFg: "250 18% 94%",
      primary: "263 72% 62%", primaryFg: "252 22% 5%",
      primaryDark: "263 80% 42%", primaryMid: "263 64% 52%",
      primaryLight: "263 55% 76%", primaryPale: "263 35% 14%",
      secondary: "252 18% 11%", secondaryFg: "250 18% 94%",
      muted: "252 16% 14%", mutedFg: "250 12% 60%",
      accent: "200 55% 58%", accentFg: "252 22% 5%",
      destructive: "0 60% 56%", destructiveFg: "0 0% 100%",
      border: "250 18% 94% / 0.08", input: "250 18% 94% / 0.10", ring: "263 72% 62%",
      surface: "252 20% 9%", surfaceLight: "252 16% 13%",
      sidebarBg: "252 28% 3%", sidebarFg: "250 18% 94%",
      sidebarPrimary: "263 72% 62%", sidebarPrimaryFg: "252 22% 5%",
      sidebarAccent: "252 20% 10%", sidebarAccentFg: "250 18% 96%",
      sidebarBorder: "250 18% 94% / 0.06", sidebarRing: "263 72% 62%",
      shadowSoft: SHADOW_DARK_SOFT, shadowElev: SHADOW_DARK_ELEV,
      fontDisplay: F_GEIST.display, fontBody: F_GEIST.body, fontMono: F_GEIST.mono,
      radius: "0.625rem", radiusSm: "0.375rem", spaceUnit: "5px", ease: EASE_FROST,
      bgGradient: "radial-gradient(ellipse 80% 30% at 50% 0%, hsl(263 72% 62% / 0.09) 0%, transparent 55%), hsl(252 22% 5%)",
    }),
  },
  ...
  // ── 4. Ember ────────────────────────────────────────────────────────
  {
    ...
    dark: tk({
      bg: "20 6% 5%", fg: "20 6% 94%",
      card: "20 6% 9%", cardFg: "20 6% 94%",
      popover: "20 6% 10%", popoverFg: "20 6% 94%",
      primary: "20 100% 58%", primaryFg: "20 6% 5%",
      primaryDark: "20 100% 38%", primaryMid: "20 90% 48%",
      primaryLight: "20 80% 70%", primaryPale: "20 40% 14%",
      secondary: "20 5% 11%", secondaryFg: "20 6% 94%",
      muted: "20 5% 14%", mutedFg: "20 5% 58%",
      accent: "195 52% 48%", accentFg: "20 6% 5%",
      destructive: "0 62% 54%", destructiveFg: "0 0% 100%",
      border: "20 6% 94% / 0.08", input: "20 6% 94% / 0.10", ring: "20 100% 58%",
      surface: "20 6% 9%", surfaceLight: "20 5% 13%",
      sidebarBg: "20 8% 3%", sidebarFg: "20 6% 94%",
      sidebarPrimary: "20 100% 58%", sidebarPrimaryFg: "20 6% 5%",
      sidebarAccent: "20 6% 10%", sidebarAccentFg: "20 6% 96%",
      sidebarBorder: "20 6% 94% / 0.06", sidebarRing: "20 100% 58%",
      shadowSoft: SHADOW_DARK_SOFT, shadowElev: SHADOW_DARK_ELEV,
      fontDisplay: F_INTER_TIGHT.display, fontBody: F_INTER_TIGHT.body, fontMono: F_INTER_TIGHT.mono,
      radius: "0.5rem", radiusSm: "0.25rem", spaceUnit: "5px", ease: EASE_ACADEMIA,
      bgGradient: "radial-gradient(ellipse 80% 30% at 50% 0%, hsl(20 100% 58% / 0.09) 0%, transparent 55%), hsl(20 6% 5%)",
    }),
  },
  ...
  // ── 5. Void ─────────────────────────────────────────────────────────
  {
    ...
    dark: tk({
      ...
      sidebarBg: "0 0% 1%", sidebarFg: "0 0% 95%",
      sidebarPrimary: "72 100% 48%", sidebarPrimaryFg: "0 0% 2%",
      sidebarAccent: "0 0% 7%", sidebarAccentFg: "0 0% 97%",
      sidebarBorder: "0 0% 96% / 0.06", sidebarRing: "72 100% 48%",
      shadowSoft: SHADOW_NOTION_SOFT, shadowElev: SHADOW_NOTION_ELEV,
      fontDisplay: F_INTER_TIGHT.display, fontBody: F_INTER_TIGHT.body, fontMono: F_INTER_TIGHT.mono,
      radius: "0.25rem", radiusSm: "0.0625rem", spaceUnit: "4px", ease: EASE_VOID,
      bgGradient: "radial-gradient(ellipse 80% 30% at 50% 0%, hsl(72 100% 48% / 0.1) 0%, transparent 55%), hsl(0 0% 2%)",
    }),
  },
];
