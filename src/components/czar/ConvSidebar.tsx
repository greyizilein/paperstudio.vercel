...
function ConvItem({ c, isActive, onSelect, onStartRename, onRequestDelete, renamingId, renameVal, setRenameVal, commitRename, cancelRename }: ConvItemProps) {
  ...
  return (
    <motion.div
      ...
      onClick={onSelect}
      className={`group relative flex items-start gap-2 px-2 py-2 rounded-lg cursor-pointer transition-colors select-none ${
        isActive
  ...
  return (
    <>
      <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground">
        ...
        {/* Swipe hint — shown only on touch devices */}
        <p className="px-3 pb-1.5 text-[10px] text-muted-foreground/40 flex-shrink-0 md:hidden">
          Swipe right to delete · left to rename
        </p>
