...
const STEP_LABELS = ["Basics", "Strategy", "Chapters", "Objectives", "Review"];
...
export function NewProject({ onBack, onCreate }: { onBack: () => void; onCreate: (p: Project) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-3">
        <h1 className="font-heading text-[18px] sm:text-[22px] font-black tracking-tight text-foreground leading-tight">Define Research Scope</h1>
      </div>
      ...
      <AnimatePresence mode="wait">
          ...
          <motion.div key="step-0" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-2.5">
            <section className="rounded-[10px] border border-border bg-card p-3.5">
              <div className="space-y-2.5">
                ...
                <div>
                  <label className="block text-[11px] font-bold text-foreground mb-1.5">Writing Intelligence Mode</label>
        ...
        {step === 1 && (
          <motion.div key="step-1" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-2.5">
            ...
            <section className="rounded-[10px] border border-border bg-card p-3.5">
              <label className="block text-[11px] font-bold text-foreground mb-1">
                Language Level — <span className="text-primary">{form.language_level}/7</span>
              </label>
              <Slider
          ...
          <motion.div key="step-2" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-2.5">
            <section className="rounded-[10px] border border-border bg-card p-3.5">
              <div className="flex items-start justify-between mb-2 gap-2">
                <CardTitle className="mb-0">Chapter Distribution</CardTitle>
          ...
          <motion.div key="step-3" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-2.5">
            <section className="rounded-[10px] border border-border bg-card p-3.5">
              <div className="flex items-center justify-between mb-2 gap-2">
                <CardTitle className="mb-0">Objectives & Questions</CardTitle>
                <button
                ...
                >
                  {aiGenerating ? <Loader2 size={10} className="animate-spin" /> : <Sparkles size={10} />} {aiGenerating ? "…" : "AI Auto"}
                </button>
              </div>
