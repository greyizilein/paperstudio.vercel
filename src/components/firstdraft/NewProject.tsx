...
import { ArrowLeft, ArrowRight, Sparkles, Info, Check, Upload, Loader2, Plus, Trash2 } from "lucide-react";
...
export function NewProject({ onBack, onCreate }: { onBack: () => void; onCreate: (p: Project) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-3">
        <h1 className="font-heading text-[18px] sm:text-[22px] font-black tracking-tight text-foreground leading-tight">Set up your dissertation</h1>
      </div>
