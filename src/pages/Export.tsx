...
export default function ExportPage() {
  return (
    <div>
      <PageHero title={<>Five formats.<br /><em style={{ fontStyle: "italic", color: "var(--ma-accent)" }}>Submit anywhere.</em></>} subtitle="Every export includes your title page, table of contents, list of figures, list of tables, and reference list." />
