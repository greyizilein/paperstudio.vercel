...
export default function PricingPage() {
  ...
  const plans = [
    ...
    {
      tier: 'Undergraduate', amt: '$30', per: 'Per project',
      desc: 'Gemini 2.5 + Gemini 3 + GPT-5.2, with Claude Sonnet 4.6 unlocked at Chapter 4.',
      features: ['All chapters, up to 50,000 words', 'Gemini 2.5 + Gemini 3 + GPT-5.2', 'Claude Sonnet 4.6 (Chapter 4 only)', '8 quantitative analysis methods', 'All 12 citation styles', 'Word (.docx) + PDF export', '3 revision rounds per chapter'],
    ...
    },
    {
      ...
      features: ['All chapters, up to 80,000 words', 'Gemini 3 Pro + GPT-5.2 + GPT-5 Flagship', 'Claude Sonnet 4.6 with adaptive thinking', 'Claude Opus 4 (Chapter 4 only)', 'All 20+ quantitative + 9 qualitative', 'All 5 export formats', '8 revisions + version history', 'Full 7-stage grammar pipeline'],
      off: ['Claude Opus 4.6'],
      hot: true, dark: false,
    },
    {
